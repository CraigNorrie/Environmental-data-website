...
![Baywater Shellfish, Thorndyke Bay, WA](/Images/Thorndyke Bay.jpg)
...
# Site Location
Sensors at Thorndyke Bay are deployed on a commercial shellfish farm. The sensors are located in an intertidal area at a tidal height of approximately 0m above mean low tide. 
...
thorndat <- read.csv(here("Data/Thorndyke","UW_THORNDYKE_DO_TEMP_WATERLEVEL_2023_2024.csv"))#Read in the data
...
Dissolved oxygen data was collected using a hobo DO and temp logger. Data was collected every 15 minutes and daily averages were calculated. Note this data included information from when sensors were emersed.
